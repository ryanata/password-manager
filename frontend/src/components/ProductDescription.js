...
export function ProductDescription() {
  return (
    ...
    <Grid grow gutter={40}>
        <Grid.Col span={4}>
            <Title sx={{ color: '#ffffff', fontSize: 60, lineHeight: 1.4, float: 'left', fontFamily: 'nunito', textAlign: 'left', paddingLeft: 30 }}>
            ...
            <Text sx={{ color: '#ffffff', fontSize: 26, lineHeight: 1.4,float: 'left',fontFamily: 'public sans', textAlign: 'left', paddingLeft: 30 }}>
                ...
                Learn how you can store, share, and secure your life with pwdly.
            </Text>
