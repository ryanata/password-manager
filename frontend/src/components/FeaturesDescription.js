...
import { IconShield, IconFolder, IconDiscountCheck, IconPlane, } from '@tabler/icons';
    ...
    return (
        <Container size="lg" py="xl">
            ...
            <Text color="white" className={classes.description} align="center" mt="md">
                With pwdly, manage all of your passwords in one place. You can store, organize, and secure your passwords with ease.
            </Text>
